...
A home opted into the [supervision host](supervision-host.md) runs it in that arm's place; its successor-cycle and handback ordering preserve the recovery and acknowledgement contracts below in both postures.
